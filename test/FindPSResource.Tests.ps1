...
Describe 'Test Find-PSResource for Module' {
    ...
    #     Get-PSResourceRepository $repoName | Should -Not -BeNullOrEmpty
        ...
        Write-Host $foundResources.Count
    ...
    #     $res = Find-PSResource -Name "TestModuleWithDependency*" -Version "[1.0.0.0, 2.0.0.0]" -Repository $PSGalleryName
    #     foreach ($pkg in $res) {
